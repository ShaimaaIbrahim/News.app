...
public class Utils {
    private static final String LOG_TAG = "hhjfhjf";
    ...
    private static List<New> extractFeatureFromJson(String earthquakeJSON) {
        ...
        List<New> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONArray baseArray=basejsonObject.getJSONArray("articles");
            for(int i=0;i<baseArray.length();i++){
                ...
                String uriImage=object.getString("urlToImage");
                String  publishedAt=object.getString("publishedAt");
                New news=new New(name,description,uriImage,publishedAt,title);
